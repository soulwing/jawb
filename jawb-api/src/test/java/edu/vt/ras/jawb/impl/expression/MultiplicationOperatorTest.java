...
/**
 * Unit tests for {@link MultiplicationOperator}.
 *
 * @author Carl Harris
 */
public class MultiplicationOperatorTest {
  ...
  private MultiplicationOperator operator = new MultiplicationOperator(a, b);

  
  @Test
  public void testEvaluate() throws Exception {
    final Value x = new Value(Value.Type.NUMBER, 2.0);
    final Value y = new Value(Value.Type.NUMBER, 2.0);
    ...
    assertThat(result.getType(), equalTo(Value.Type.NUMBER));
    assertThat(result.getValue(), equalTo((Object) 4.0));    
  }
