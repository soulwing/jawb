...
/**
 * Unit tests for {@link ExclusiveOrOperator}.
 *
 * @author Carl Harris
 */
public class ExclusiveOrOperatorTest {
  ...
  private ExclusiveOrOperator operator = new ExclusiveOrOperator(a, b);

  
  @Test
  public void testEvaluate() throws Exception {
    final Value x = new Value(Value.Type.BOOLEAN, true);
