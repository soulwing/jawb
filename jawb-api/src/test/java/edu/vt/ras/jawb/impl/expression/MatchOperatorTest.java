...
/**
 * Unit tests for {@link MatchOperator}.
 *
 * @author Carl Harris
 */
public class MatchOperatorTest {
  ...
  private MatchOperator operator = new MatchOperator(a, b);

  
  @Test
  public void testEvaluate() throws Exception {
    final Value x = new Value(Value.Type.STRING, "string1-string2-string3");
    final Value y = new Value(Value.Type.STRING, "string2");
