...
/**
 * Unit tests for {@link LessOrEqualsOperator}.
 *
 * @author Carl Harris
 */
public class LessOrEqualsOperatorTest {
  ...
  private LessOrEqualsOperator operator = new LessOrEqualsOperator(a, b);

  
  @Test
  public void testEvaluateLessThan() throws Exception {
