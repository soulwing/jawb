...
import org.soulwing.jawb.impl.expression.NegationOperator;
...
/**
 * Unit tests for {@link NegationOperator}.
 *
 * @author Carl Harris
 */
public class NegationOperatorTest {
  ...
  private NegationOperator operator = new NegationOperator(operand);
  
  @Test
  public void testEvaluate() throws Exception {
    final Value result = new Value(Value.Type.NUMBER, 1.0);
    ...
    assertThat(value.getValue(), equalTo((Object) Double.valueOf(-1.0)));
