...
/**
 * A {@link BindingStrategy} for an attribute with an array type.
 *
 * @author Carl Harris
 */
class ArrayTypeBindingStrategy implements BindingStrategy {

  public static final BindingStrategy INSTANCE =
      new ArrayTypeBindingStrategy();
  
  private ArrayTypeBindingStrategy() {
  }
